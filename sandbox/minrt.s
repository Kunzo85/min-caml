...
fmod.2463:
    ...
    fsw      %f0  %sp  0                   # !131
    fsw      %f1  %sp  -1                  # !131
    fmovz    %f0  %f2  %zero               # !131
    sw       %ra  %sp  -2                  # !131
    addi     %sp  %sp  -3                  # !131
    jal      ~min_caml_floor               # !131
    addi     %sp  %sp  3                   # !131
    lw       %ra  %sp  -2                  # !131
    flw      %f1  %sp  -1                  # !131
    fmul     %f0  %f0  %f1                 # !131
...
sin.2468:
    ...
    sw       %ra  %sp  -2                  # !146
    addi     %sp  %sp  -3                  # !146
    jal      ~reduce_to_pi.2466            # !146
    addi     %sp  %sp  3                   # !146
    lw       %ra  %sp  -2                  # !146
    flw      %f1  %sp  -1                  # !148
    fblt     %f1  %f0  fblt_then.9270      # !148
    flui     %f1  -514                     # !149
    fli      %f1  593883                   # !149
    ++
    fli -1.570796
    => flui %f1 0b10111111110
       fli  %f1 0b010010000111111011011
    ++
    fblt     %f0  %f1  fblt_then.9272      # !149
    j        ~fblt_cont.9273               # !149
fblt_then.9272:
    flui     %f1  -510                     # !149
    fli      %f1  593883                   # !149
    ++
...
atan.2472:
    ...
    ++
    fblt     %f0  %f1  fblt_then.9275      # !180
    j        ~atan_poly.5848               # !181
fblt_then.9275:
    flui     %f1  -514                     # !180
    fli      %f1  593883                   # !180
    ++
